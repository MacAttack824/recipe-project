...
class Recipe: 
	def __init__(self, name: str, id: int, basic_ing: list[str], ingredients: list[str], cook_time: int, steps: list[str], suggested_sides:list[str], tags: list[str]):
		self.name = name
		self.id = id
...
print(recipe_738.name, recipe_738.tags)
